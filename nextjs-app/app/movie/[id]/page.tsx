...
import { FALLBACK_MOVIES } from '../../../lib/initialCatalog';
...
async function getMovieById(id: string): Promise<any | null> {
  ...
  if (found) {
    return {
      id: found.id,
      title: found.title,
      original_title: found.title,
      year: found.year,
      genres: found.genre ? found.genre.split(/[,/]/).map((g) => g.trim()) : ['Action'],
      poster_url: found.poster,
      backdrop_url: found.backdrop || found.poster,
      tg_link: found.tgLink,
      type: found.type,
      quality: found.quality || 'HD',
      synopsis: found.synopsis,
      rating: found.rating ? Number(found.rating) : 8.5,
      duration: found.duration ? 110 : 105,
    };
  }
